...
// Helper function to download content and return it as a string
...
app.post('/scrape', async (req, res) => {
    ...
    try {
        ...
        if (contentTypes.includes('img')) {
            ...
            results.images = imgFiles; // Return URLs for images
        }
        ...
        if (contentTypes.includes('video')) {
            ...
            results.videos = videoFiles; // Return URLs for videos
        }
